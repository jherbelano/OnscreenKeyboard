...
namespace Oskeyboard
{
	public partial class Form1 : Form
	{
        ...
        private async void FlashInForm1(int h, int w)
        {
            this.Width = 0;
            this.Height = 0;
            ...
            int x = Screen.PrimaryScreen.Bounds.Width - w;
            int y = Screen.PrimaryScreen.Bounds.Height - h;
        ...
        private async Task<bool> FlashOutForm()
        {
            await Task.Run(() =>
            {
                Transition t = new Transition(new TransitionType_EaseInEaseOut(500));
                t.add(this, "Width", 0);
                t.add(this, "Height", 0);
                t.add(this, "Top", Cursor.Position.Y);
                t.add(this, "Left", Cursor.Position.X);
                t.run();
		...
		private void Form1_Load(object sender, EventArgs e)
		{
            ...
            FlashInForm1(this.Height, this.Width);
        }
